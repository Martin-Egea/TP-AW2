    ...
    <nav class="bg-gray-800 bg-opacity-80 shadow shadow-slate-950 fixed top-0 left-0 w-full z-50">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="${API}/pages/userSales/userSales.html" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Historial de compras</a>
        ...
        <div class="sm:hidden" id="mobile-menu">
          <div id="menuNavbar" class="space-y-1 px-2 pb-3 pt-2 hidden">
            ...
            <a href="${API}/pages/userSales/userSales.html" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Historial de compras</a>
