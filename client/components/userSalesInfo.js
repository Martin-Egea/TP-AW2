...
export const userSalesInfo = (direccion, ciudad, pais, provincia, codPostal, telefono, productos, createdAt, updatedAt)=>{
    return `
        <div id="infoUserSales" class="grid grid-cols-1 md:grid-cols-2">
            <div class="mb-4">
                <h2 class="text-lg font-semibold">ID del Usuario</h2><p>6682c0460fbe5ca063ee51c6</p>
            </div>
            <div class="mb-4">
